...
export default function Footer() {
  ...
  const quickLinks = [
    { labelKey: 'OurRooms', href: '#spaces' },
    { labelKey: 'StudioRental', href: '#spaces' },
    { labelKey: 'GallerySpace', href: '#spaces' },
    { labelKey: 'LocalShop', href: '#spaces' },
    { labelKey: 'BookDirect', href: '#contact' },
  ];

  return (
    <footer id="contact" className="bg-forest py-16 px-6 md:px-10 lg:px-36">
      <div className="max-w-[1152px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-12 border-b border-cream/20 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                <Phone className="w-4 h-4 text-cream/60 flex-shrink-0" />
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <a
                href="#"
                className="w-8 h-8 bg-cream/20 rounded-full flex items-center justify-center hover:bg-cream/30 transition-colors"
                aria-label="Facebook"
              >
                <FacebookIcon />
              </a>
            ...
            <p className="text-xs text-cream/60 leading-4 tracking-tight">
              {t('BookingNote')}
            </p>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center items-center gap-2 text-sm">
            <Link href="#" className="text-cream hover:underline tracking-tight">
              {t('PrivacyPolicy')}
            </Link>
